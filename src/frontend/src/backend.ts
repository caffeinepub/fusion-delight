...
export class Backend implements backendInterface {
    ...
    async addContactSubmission(arg0: string, arg1: string, arg2: string): Promise<bigint> {
    ...
    async addMenuCategory(arg0: string, arg1: Array<MenuItem>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMenuCategory(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addReservation(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
